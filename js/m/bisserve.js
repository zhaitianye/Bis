...
/*六次购买服务*/
$(".buyv1").click(function() {
    var setid = $("#serviceidv1").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val("53");
    $(".payshow").show();
});
$(".buyv2").click(function() {
    var setid = $("#serviceidv2").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val("21");
    $(".payshow").show();
});
$(".buyv3").click(function() {
    var sernum = $(".text_boxv2").text();
    var setid = $("#serviceidv3").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val(sernum);
    $(".payshow").show();
});
$(".buyv4").click(function() {
    var setid = $("#serviceidv4").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val("53");
    $(".payshow").show();
});
$(".buyv5").click(function() {
    var setid = $("#serviceidv5").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val("21");
    $(".payshow").show();
});
$(".buyv6").click(function() {
    var sernum = $(".text_boxv3").text();
    var setid = $("#serviceidv6").val();
    $("#servicetype").val(setid);
    $("#servicenumber").val(sernum);
    $(".payshow").show();
});